export const environment = {
    production: false,
    // Configuración de Firebase que tiene conexión con l aplicación y
    // con los servicios de Firebase como autenticación, almacenamiento, etc
    firebaseConfig: {
        apiKey: "AIzaSyAobrOzqWMRXijJzwQHpQGIDeJvb8LR9dY",
        authDomain: "horneaditos-2005.firebaseapp.com",
        projectId: "horneaditos-2005",
